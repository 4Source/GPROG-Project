...
public class Avatar extends Character {
	...
	public Avatar(WorldPos start) {
		super(e -> new CharacterSpriteComponent(e, new CharacterAnimationKey(CharacterAction.IDLE, CharacterDirection.DOWN, CharacterEquipment.GUN)), new CircleHitBox(HitBoxType.Block, 12, new Offset(0, 20)), e -> new DynamicPhysicsComponent(e, new RectangleHitBox(HitBoxType.Block, 20, 30), PhysicsCollisionLayer.PLAYER_CHARACTER, new PhysicsCollisionMask(PhysicsCollisionLayer.ZOMBIE)), e -> new PlayerMovementComponent(e, start, 200), e -> new LifeComponent(e, 100) {
			@Override
			public void kill() {
