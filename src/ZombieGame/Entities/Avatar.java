...
public class Avatar extends Character {
	...
	public Avatar(WorldPos start) {
		super(e -> new CharacterSpriteComponent(e, new CharacterAnimationKey(CharacterAction.IDLE, CharacterDirection.DOWN, CharacterEquipment.HANDS, CharacterAttackState.NO_ATTACK)),
				new CircleHitBox(HitBoxType.Block, 12, new Offset(0, 20)),
				e -> new DynamicPhysicsComponent(e, new RectangleHitBox(HitBoxType.Block, 20, 30), PhysicsCollisionLayer.HURTBOX, new PhysicsCollisionMask(PhysicsCollisionLayer.PROJECTILE)),
		...
		this.playerDirectionComponent = this.add(new PlayerDirectionComponent(this));
	...
	private void addSprites(Avatar avatar) {
		...
		this.getVisualComponent().addSprite(CharacterPart.BODY, new CharacterAnimationKey(CharacterAction.IDLE, CharacterDirection.RIGHT, null, null), new LoopingSprite("assets/ostApocalypse_AssetPack/Character/Main/Idle/Character_side_idle_no-hands-Sheet6.png", 6, 1, scale, animationFrameTime));
	...
	public PlayerDirectionComponent getPlayerDirectionComponent() {
		return this.playerDirectionComponent;
	}
