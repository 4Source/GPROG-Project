...
public class Gunshot extends Projectile {
	...
	public Gunshot(Entity owner, WorldPos pos, double alpha, double speed, double lifetime, int damage) {
		super(owner, pos, alpha, speed, lifetime, damage, new CircleHitBox(HitBoxType.Block, 4), new PhysicsCollisionMask(PhysicsCollisionLayer.OBSTACLES, PhysicsCollisionLayer.HURTBOX), e -> new CircleComponent(e, 4, Color.YELLOW));
	}
