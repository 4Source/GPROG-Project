...
public class AxeZombie extends Zombie {
	...
	public AxeZombie(WorldPos start) {
		...
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.IDLE, CharacterDirection.DOWN, CharacterEquipment.AXE),
				new LoopingSprite(base + "_Down_Idle-Sheet6.png", 6, 1, scale, animationFrameTime));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.IDLE, CharacterDirection.RIGHT, CharacterEquipment.AXE),
				new LoopingSprite(base + "_Side_Idle-Sheet6.png", 6, 1, scale, animationFrameTime));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.IDLE, CharacterDirection.LEFT, CharacterEquipment.AXE),
				new LoopingSprite(base + "_Side-left_Idle-Sheet6.png", 6, 1, scale, animationFrameTime));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.IDLE, CharacterDirection.UP, CharacterEquipment.AXE),
		...
		// MOVE WITH AXE
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.MOVE, CharacterDirection.DOWN, CharacterEquipment.AXE),
				new LoopingSprite(base + "_Down_Walk-Sheet8.png", 8, 1, scale, animationFrameTime));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.MOVE, CharacterDirection.RIGHT, CharacterEquipment.AXE),
				new LoopingSprite(base + "_Side_Walk-Sheet8.png", 8, 1, scale, animationFrameTime));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.MOVE, CharacterDirection.LEFT, CharacterEquipment.AXE),
				new LoopingSprite(base + "_Side-left_Walk-Sheet8.png", 8, 1, scale, animationFrameTime));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.MOVE, CharacterDirection.UP, CharacterEquipment.AXE),
		...
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.ATTACK, CharacterDirection.DOWN, CharacterEquipment.AXE),
				new OneShotSprite(base + "_Down_First-Attack-Sheet7.png", 7, 1, scale, animationFrameTime, () -> onAttackEnd()));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.ATTACK, CharacterDirection.RIGHT, CharacterEquipment.AXE),
				new OneShotSprite(base + "_Side_First-Attack-Sheet7.png", 7, 1, scale, animationFrameTime, () -> onAttackEnd()));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.ATTACK, CharacterDirection.LEFT, CharacterEquipment.AXE),
				new OneShotSprite(base + "_Side-left_First-Attack-Sheet7.png", 7, 1, scale, animationFrameTime, () -> onAttackEnd()));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.ATTACK, CharacterDirection.UP, CharacterEquipment.AXE),
		...
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.SPECIAL_ATTACK, CharacterDirection.DOWN, CharacterEquipment.AXE),
				new OneShotSprite(base + "_Down_Second-Attack-Sheet9.png", 9, 1, scale, animationFrameTime, () -> onAttackEnd()));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.SPECIAL_ATTACK, CharacterDirection.RIGHT, CharacterEquipment.AXE),
				new OneShotSprite(base + "_Side_Second-Attack-Sheet9.png", 9, 1, scale, animationFrameTime, () -> onAttackEnd()));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.SPECIAL_ATTACK, CharacterDirection.LEFT, CharacterEquipment.AXE),
				new OneShotSprite(base + "_Side-left_Second-Attack-Sheet9.png", 9, 1, scale, animationFrameTime, () -> onAttackEnd()));
		this.getVisualComponent().addSprite(CharacterPart.BODY,
				new CharacterAnimationKey(CharacterAction.SPECIAL_ATTACK, CharacterDirection.UP, CharacterEquipment.AXE),
